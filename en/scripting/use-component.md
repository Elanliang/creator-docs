...
We recommend that a popular editor is used, such as: Vim, Sublime Text, WebStorm, VSCode, etc. Each editor has advantages and disadvantages. Please set it up in [preferences](../getting-started/basics/editor-panels/preferences.md#data-editor) first.
